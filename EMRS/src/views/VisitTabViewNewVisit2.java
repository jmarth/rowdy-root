...
public class VisitTabViewNewVisit2 extends JPanel {
	...
	public VisitTabViewNewVisit2(Visit visit, Patient patient, JTabbedPane tabbedPane, HomeModel homeModel) {
		super();
	 ...
	 */
	public VisitTabViewNewVisit2(Visit visit, Patient patient, JTabbedPane tabbedPane, HomeModel homeModel, Boolean b) {
		super();
	...
	public VisitTabViewNewVisit2(final JTabbedPane tabbedPane, Patient patient, HomeModel homeModel) {
		this.patient = patient;
		this.tabbedPane = tabbedPane;
		this.homeModel = homeModel;

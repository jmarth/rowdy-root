...
public class Test extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Test (Visit v, Patient p, JTabbedPane tP, HomeModel hM, Boolean b) {
	...
	public Test() {
		...
		JLabel label_SLE_Sketch = new JLabel("<eye image>");
		...
		panel_Vision.add(panel_IOP, "cell 0 5,grow");
		...
		panel_Vision.add(panel_Gonio, "cell 0 6,alignx left,growy");
		
		JButton btnGonioSketch = new JButton("Sketch");
		panel_Gonio.add(btnGonioSketch);
		
		JLabel lblGonioSketch = new JLabel("<gonio image>");
		...
		panel_Vision.add(panel_FundusExam, "cell 0 7,grow");
		...
		JButton btnFundusSketch = new JButton("Sketch");
		panel_FundusImage.add(btnFundusSketch);
		
		JLabel lblFundusSketch = new JLabel("<fundus image>");
